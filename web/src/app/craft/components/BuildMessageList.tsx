      ...
      <div className="w-full max-w-2xl backdrop-blur-md rounded-16 p-4">
        ...
        {messages.map((message, idx) => {
          ...
          if (message.type === "assistant") {
            // Anchor trailing slot (e.g. approval cards) under the last
            // saved assistant message — but only when there's no live
            // streaming area, since that case has its own anchor below.
            const trailing =
